-- MASTER SETUP SCRIPT (SAFE VERSION)
-- Run this to set up the entire database. It checks if things exist before creating them.
...
-- INSERT ACTUAL DATA (Updates if exists)
