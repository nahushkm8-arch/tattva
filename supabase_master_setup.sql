-- MASTER SETUP SCRIPT
-- Run this to set up the entire database with all features:
-- 1. User Profiles (stores First/Last Name automatically on signup)
-- 2. Products (pre-loaded with your website data)
-- 3. Cart, Orders, Wishlist, Addresses

-- Enable UUID extension
create extension if not exists "uuid-ossp";

-- ==========================================
-- 1. USER PROFILES (Stores User Name)
-- ==========================================
...
-- TRIGGER: Automatically saves User Name from Sign Up form to this table
...
-- ==========================================
-- 2. PRODUCTS (Stores Product Name, Image, Price)
-- ==========================================
